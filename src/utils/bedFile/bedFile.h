...
public:
    template <typename T> inline void reportBedTab(const T &bed);
    template <typename T> inline void reportBedNewLine(const T &bed);
    template <typename T> inline void reportBedRangeTab(const T &bed, CHRPOS start, CHRPOS end);
    template <typename T> inline void reportBedRangeNewLine(const T &bed, CHRPOS start, CHRPOS end);
...
template <typename T>
inline void BedFile::reportBedTab(const T &bed) {
